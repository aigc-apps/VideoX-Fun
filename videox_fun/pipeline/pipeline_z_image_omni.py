...
from ..models import AutoencoderKL, ZImageOmniTransformer2DModel
from ..models.flux2_image_processor import Flux2ImageProcessor
...
class ZImageOmniPipeline(DiffusionPipeline, FromSingleFileMixin):
