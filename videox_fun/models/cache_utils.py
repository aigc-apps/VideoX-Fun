...
def get_teacache_coefficients(model_name):
    ...
    elif "wan2.1-t2v-14b" in model_name.lower() or "wan2.1-i2v-14b-480p" in model_name.lower() or "wan2.1-i2v-14b-720p" in model_name.lower() or "wan2.1-fun-14b" in model_name.lower() or "wan2.1-fun-v1.1-14b" in model_name.lower():
