...
# The transformer alone is 61.7 GB in bfloat16 and the Qwen3-VL conditioner is another 62.1 GB, so a single 80 GB
# card needs model_cpu_offload or model_group_offload.
...
# `torchrun --nproc_per_node=2 examples/minimax_h3/predict_t2v.py` for ulysses_degree=2, ring_degree=1.
...
vae_path            = None
lora_path           = None # "output_dir_minimax_h3_lora/checkpoint-200/lora_diffusion_pytorch_model.safetensors"
