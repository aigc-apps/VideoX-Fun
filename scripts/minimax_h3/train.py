...
#
# Full finetuning of the packed-sequence transformer on the *video and audio* rows together, covering both `t2v`
...
def parse_args():
    parser = argparse.ArgumentParser(description="MiniMax-H3 training (video + audio, t2v / fl2v).")
    parser.add_argument(
