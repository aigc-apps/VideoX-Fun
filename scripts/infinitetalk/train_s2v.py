...
def log_validation(vae, text_encoder, tokenizer, audio_encoder, transformer3d, clip_image_encoder, args, config, accelerator, weight_dtype, global_step):
    try:
        ...
        with torch.no_grad(), torch.cuda.amp.autocast(dtype=weight_dtype), torch.cuda.device(device=accelerator.device):
            ...
            transformer3d = accelerator.unwrap_model(transformer3d) if type(transformer3d).__name__ == 'DistributedDataParallel' else transformer3d
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            with accelerator.accumulate(transformer3d):
                ...
                with torch.no_grad():
                    ...
                    print(latents.size(), msk_pixel.size(), pixel_values.size())
